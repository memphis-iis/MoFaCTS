...
const FALLBACK_THEME = {
  ...
  properties: {
    ...
    public_page_surface_color: '#F8FBF9',
    public_alt_surface_color: '#EAF5EF',
    public_card_surface_color: '#FFFFFF',
    public_text_color: '#14231F',
    public_muted_text_color: '#596B63',
    public_border_color: '#D9E6DF',
    public_primary_action_surface_color: '#156B4F',
    public_primary_action_text_color: '#FFFFFF',
    public_hero_decoration_color: '#5ADAAA',
