...
describe('tar archive helpers', function() {
  it('round-trips dynamic asset paths that require the ustar prefix field', async function() {
    const longPath = 'dynamic-assets/packages/724e0b9f73f3e9334aac6b79e250b048c89e5b1d3f4d7bc3eb85af80fb40d5e8/generated/content-package.json';
