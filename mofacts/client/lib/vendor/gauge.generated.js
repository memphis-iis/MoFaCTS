...
(function() {
  var AnimatedText, _AnimatedTextFactory, _Bar, AnimationUpdater, BaseDonut, BaseGauge, Donut, Gauge, GaugePointer, TextRenderer, ValueUpdater, addCommas, cutHex, formatNumber, mergeObjects, secondsToString,
    slice = [].slice,
  ...
  Gauge = (function(superClass) {
    ...
    Gauge.prototype.renderTicks = function(ticksOptions, _w, _h, _radius) {
      var currentDivision, currentSubDivision, divColor, divLength, divWidth, divisionCount, j, lineWidth, range, rangeDivisions, ref, results, scaleMutate, subColor, subDivisions, subLength, subWidth, subdivisionCount, t, tmpRadius;
      if (ticksOptions && Object.keys(ticksOptions).length > 0) {
        ...
        for (t = j = 0, ref = divisionCount + 1; j < ref; t = j += 1) {
          ...
          if (t !== ticksOptions.divisions && subdivisionCount > 0) {
            results.push((function() {
              var _st, l, ref1, results1;
              results1 = [];
              for (_st = l = 0, ref1 = subdivisionCount - 1; l < ref1; _st = l += 1) {
