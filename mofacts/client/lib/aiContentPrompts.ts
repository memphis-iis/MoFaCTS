...
export const AI_CONTENT_INTENT_SCHEMA: OpenRouterJsonSchema = {
  ...
  required: ['promptType', 'responseType', 'subject', 'listSearchQuery', 'imageRequirement'],
  properties: {
...
export function validateAiContentIntent(value: unknown): AiContentIntent {
  ...
  strictKeys(value, ['promptType', 'responseType', 'subject', 'listSearchQuery', 'imageRequirement'], 'AI Content intent');
  ...
  return { promptType: value.promptType, responseType: 'text', subject, listSearchQuery, imageRequirement };
}
