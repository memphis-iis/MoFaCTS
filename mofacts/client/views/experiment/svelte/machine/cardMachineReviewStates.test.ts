...
describe('card machine review states', function() {
  const studyState = cardMachineReviewStates[STATES.STUDY] as unknown as StateNode;
  const feedbackState = cardMachineReviewStates[STATES.FEEDBACK] as unknown as StateNode;
