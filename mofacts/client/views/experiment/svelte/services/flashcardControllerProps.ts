...
export interface FlashcardControllerButton {
...
export interface FlashcardControllerDeliverySettings {
...
export interface TrialLikeForFlashcardControllerProps {
...
export interface FlashcardControllerPropsBuilderInput {
  ...
  readonly slotState?: FlashcardControllerSlotState;
  readonly trialLike: TrialLikeForFlashcardControllerProps | null | undefined;
}

export interface FlashcardControllerPropsBuildResult {
...
export interface FlashcardControllerPropsFromSubsetInput {
  readonly buttonList: unknown;
...
export function getCorrectAnswerImageSrc(
  ...
  const match = buttonList.find((button: unknown) => {
    const candidate = button as FlashcardControllerButton | null | undefined;
    return candidate &&
      candidate.isImage &&
      (
  ...
  }) as FlashcardControllerButton | undefined;

  return match?.buttonName || '';
}

export function buildFlashcardControllerProps(
  input: FlashcardControllerPropsBuilderInput,
): FlashcardControllerPropsBuildResult {
  ...
  return buildFlashcardControllerPropsFromSubset({
    buttonList,
    correctAnswer,
...
export function buildFlashcardControllerPropsFromSubset(
  input: FlashcardControllerPropsFromSubsetInput,
): FlashcardControllerPropsBuildResult {
