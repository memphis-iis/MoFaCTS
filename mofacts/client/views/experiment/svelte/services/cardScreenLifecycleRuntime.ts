...
import type { CardMachineSnapshot } from './cardMachineRuntime';
import type { CardRuntimeLifecycleController } from './cardRuntimeLifecycle';

export interface CardScreenLifecycleRuntimeOptions {
...
export function createCardScreenLifecycleRuntime(options: CardScreenLifecycleRuntimeOptions) {
