<script>
  /**
   * TestCardWrapper - Minimal wrapper for testing PerformanceArea + TrialContent
   * Replicates CardScreen structure without XState machine
   */
...
<style>
  .card-screen {
    /* Match CardScreen.svelte layout */
