...
- `email` - Canonical email address used for account identity
...
2. **OpenID Connect**: Uses standard `openid` and `email` scopes
3. **Async/Await**: Compatible with Meteor 2.14+ async patterns
4. **Multi-tenant**: Supports Azure AD multi-tenancy
