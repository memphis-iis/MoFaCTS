...
import type { TrialDisplayAdapter } from '../../learning-components/runtime/TrialDisplayAdapterRegistry';
import { getH5PDisplayConfig, normalizeH5PDisplayConfig } from './lib/h5pDisplay';
import { normalizeH5PTrialResult } from './lib/h5pTrialResult';
import type { H5PDisplayConfig, H5PTrialResult } from './types/h5p';
