...
- Text runs make one strict definition request per source entry. The source entry supplies the response, and a definition that reveals that response is rejected without removing the item from review.
