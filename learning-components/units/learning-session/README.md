...
App-owned Meteor Session, routing, persistence, authorization, and server-method capabilities are passed in through the manifest dependency adapter rather than read directly by the package.
